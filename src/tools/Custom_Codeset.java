...
public class Custom_Codeset {
	public class Roles {
		...
		public void toolsuserdpdwn() 
		{
			...
			driver.findElement(By.xpath("//li[@aria-label='Custom Codesets']")).click();  //click on custom codeset
			WebElement dblclck = driver.findElement(By.xpath("//div//tr[@aria-rowindex=\"1\"]")); //click on grid to open
